    ...
    return <section id="intro" className="min-h-[50vh]">
        ...
        <div id='intro-ana' className='bg-base-100 p-10 rounded-md border border-base-300 mb-10'>
            ...
            <ul className="list-disc list-inside mt-6">
                <li className="text-2xl mt-4">각종 코딩 테스트와 프로그래밍 경진 대회를 준비하는 모임이에요</li>
                <li className="text-2xl mt-4">알고리즘 문제 해결을 좋아하는 사람들의 모임이에요</li>
        ...
        <div id='intro-roadmap' className='bg-base-100 p-10 rounded-md border border-base-300 mb-10'>
            <h3 className="text-4xl font-extrabold text-center underline decoration-teal-600 decoration-10">
                2026년 월별 계획
            </h3>
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-8 mt-8 pb-10 border-b-2 border-base-300">
                ...
                <div className="bg-base-100 rounded-md shadow-md p-6 border border-base-300">
                    <p className="text-4xl font-semibold text-gray-800 flex items-center">
            ...
            <ul className="list-disc list-inside mt-8 space-y-6">
                <li className="text-2xl font-semibold flex items-center space-x-4">
                    <span>🏆</span>
        ...
        <div id='intro-result' className='bg-base-100 p-10 rounded-md border border-base-300 mb-10'>
            <h3 className="text-4xl font-extrabold underline decoration-teal-600 decoration-10">실적</h3>
            ...
            <div id="ICPCAsiaPreliminary2024" className="flex flex-col justify-start items-start">
                <ul className="list-disc list-inside mt-4">
                    <li className="text-2xl mt-2 font-bold">2024 ICPC Asia Seoul Preliminary Contest</li>
                </ul>
                <div className="grid grid-cols-5 w-full border border-gray-300 text-left mt-3">
                    {/* 헤더 */}
                    ...
                    <div className="p-2 font-bold bg-gray-100 border-b border-gray-300"></div>
                    <div className="p-2 font-bold bg-gray-100 border-b border-gray-300">참가자</div>
                    <div className="p-2 font-bold bg-gray-100 border-b border-gray-300"></div>
            ...
            <div id="ICPCAsiaRegional2024" className="flex flex-col justify-start items-start">
                <ul className="list-disc list-inside mt-4">
                    <li className="text-2xl mt-2 font-bold">2024 ICPC Asia Seoul Regional Contest</li>
                </ul>
                <div className="grid grid-cols-5 w-full border border-gray-300 text-left mt-3">
            ...
            <div id="UCPCPreliminary2024" className="flex flex-col justify-start items-start">
                <ul className="list-disc list-inside mt-4">
                    <li className="text-2xl mt-2 font-bold">2024 UCPC 예선</li>
                </ul>
                <div className="grid grid-cols-5 w-full border border-gray-300 text-left mt-3">
                    <div className="p-2 font-bold bg-gray-100 border-b border-gray-300">#</div>
                    <div className="p-2 font-bold bg-gray-100 border-b border-gray-300">팀</div>
...
const KakaoMap = () => {
    ...
    return (
        <div
            ref={mapRef}
            className="w-full h-[400px] rounded-md shadow-md border border-black-100 mt-8"
        />
    );
};
...
const Activities = () => {
    ...
    return <section id="activities" className="min-h-[50vh]">
        ...
        <div id='act-education' className='bg-base-100 p-10 rounded-md border border-base-300 mb-10'>
            ...
            <h3 className="text-4xl font-extrabold underline decoration-indigo-600 decoration-10 mb-10">교육</h3>
            ...
            <div className='flex flex-col divide-y-3 divide-gray-200'>
                ...
                <div className='grid grid-cols-3 gap-3 py-7'>
                    ...
                    <div className='flex flex-row justify-center items-center'>
                        <h4 className='text-xl text-center font-bold'>입문자용 Java & Python<br /> 교육</h4>
                    </div>
                </div>
                <div className='grid grid-cols-3 gap-3 py-7'>
                    ...
                    <div className='flex flex-row justify-center items-center'>
                        <h4 className='text-xl text-center font-bold'>알고리즘 초급/중급 교육</h4>
                    </div>
                </div>
                <div className='grid grid-cols-3 gap-3 py-7'>
                    ...
                    <div className='flex flex-row justify-center items-center'>
                        <h4 className='text-xl text-center font-bold'>시스템 해킹 기초 교육</h4>
                    </div>
                </div>
        ...
        <div id='act-etc' className='bg-base-100 p-10 rounded-md border border-base-300 mb-10'>
            <h3 className="text-4xl font-extrabold underline decoration-indigo-600 decoration-10 mb-10">그 외</h3>
