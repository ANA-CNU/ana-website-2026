...
// Define the shape of a post based on what we need to display
interface Post {
    urlid: string;
    title: string;
    createdAt?: string; // Or however we get the date. If not available, we might omit or format otherwise.
}
        ...
        <main className="container mx-auto max-w-6xl p-4 space-y-5">
            ...
            <div className="card lg:card-side bg-base-100 shadow-md">
                <figure className="lg:w-2/3 bg-gray-300 min-h-[240px] aspect-[2/1]">
                    <img src="https://anacnu.kr/images/Activities-algorithm-study.jpeg" alt="Banner" className="w-full h-full object-cover" />
                </figure>
                <div className="card-body lg:w-1/3 justify-center">
                    <h2 className="card-title font-bold">ICPC 2025 예선</h2>
                    <p className="text-sm text-gray-500">대회 일정 및 팀 구성을 확인하세요.</p>
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-3">
                {[{
                    name: '아나 동아리 가입', url: 'https://www.naver.com', svg: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                    </svg>
                },
                {
                    name: '공지사항', url: '/board/notice', svg: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z" />
                    </svg>

                },
                {
                    name: 'ANA Online Judge', url: 'https://aoj.anacnu.kr', svg: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 9.75 16.5 12l-2.25 2.25m-4.5 0L7.5 12l2.25-2.25M6 20.25h12A2.25 2.25 0 0 0 20.25 18V6A2.25 2.25 0 0 0 18 3.75H6A2.25 2.25 0 0 0 3.75 6v12A2.25 2.25 0 0 0 6 20.25Z" />
                    </svg>

                },
                {
                    name: 'ANABADA', url: 'https://bada.anacnu.kr/', svg: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z" />
                    </svg>

                },
                {
                    name: 'solved.ac', url: 'https://solved.ac/', svg: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                {
                    name: '백준', url: '', svg: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3-4.5 16.5" />
                    </svg>

                }].map((item) => (
                    <a href={item.url} key={item.name} className="btn btn-outline bg-base-100 border-gray-200 text-gray-600 hover:bg-primary hover:border-primary hover:text-white h-20 flex-col gap-1 shadow-sm">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-5">
                ...
                <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <Board title="학과 공지" category="csenotice" />
                ...
                <div className="space-y-5 h-fit lg:col-span-1">
                    ...
                    <div className="card bg-base-100 shadow-md h-fit overflow-hidden">
                        ...
                        <div className="p-4 text-sm">
                            <span className="badge badge-outline badge-sm mb-1">Silver I</span>
                            <p className="font-bold truncate">#1234 숨바꼭질</p>
                            <button className="btn btn-primary btn-block btn-sm mt-3">도전하기</button>
                        </div>
                    </div>
                </div>
            </div>
...
const Board: React.FC<{ title: string, category: string }> = ({ title, category }) => {
    ...
    useEffect(() => {
        const fetchPosts = async () => {
            try {
                const res = await axios.get<BoardResponse>('/api/board/posts', {
                    ...
                    {posts.length === 0 ? (
                        ...
                        posts.map((post) => (
                            <li key={post.urlid} className="flex justify-between items-center cursor-pointer hover:text-primary group border-b border-base-100 last:border-0 pb-2 last:pb-0">
                                <Link to={`/board/post/${post.urlid}`} className="truncate w-3/4 text-gray-600 group-hover:text-primary flex items-center gap-2">
                                    {post.title}
